...
#include "../../stack/include/sdpint.h"
...
**
*******************************************************************************/
tSDP_DISC_REC *SDP_FindServiceInDb(tSDP_DISCOVERY_DB *p_db, uint16_t service_uuid,
                                   tSDP_DISC_REC *p_start_rec)
{
#if SDP_CLIENT_ENABLED == TRUE
    tSDP_DISC_REC   *p_rec;
...
**
*******************************************************************************/
uint8_t SDP_FindProtocolListElemInRec(tSDP_DISC_REC *p_rec, uint16_t layer_uuid,
                                      tSDP_PROTOCOL_ELEM *p_elem)
{
#if SDP_CLIENT_ENABLED == TRUE
    tSDP_DISC_ATTR  *p_attr;
...
**
*******************************************************************************/
uint8_t SDP_FindAddProtoListsElemInRec(tSDP_DISC_REC *p_rec, uint16_t layer_uuid,
                                       tSDP_PROTOCOL_ELEM *p_elem)
{
#if SDP_CLIENT_ENABLED == TRUE
    tSDP_DISC_ATTR  *p_attr, *p_sattr;
...
**
*******************************************************************************/
uint8_t SDP_FindProfileVersionInRec(tSDP_DISC_REC *p_rec, uint16_t profile_uuid,
                                    uint16_t *p_version)
{
#if SDP_CLIENT_ENABLED == TRUE
    tSDP_DISC_ATTR  *p_attr, *p_sattr;
