...
INLINE OI_UINT16 OI_SBC_CalculateFrameAndHeaderlen(OI_CODEC_SBC_FRAME_INFO *frame,
        OI_UINT *headerLen_)
{
                             ...
                             OI_UINT bitcount)
{
    ...
    {
        OI_UINT ex;
        bitadjust = adjustToFitBitpool(common->frameInfo.bitpool, bitneeds->uint32, nrof_subbands, bitcount,
                                       &ex);
