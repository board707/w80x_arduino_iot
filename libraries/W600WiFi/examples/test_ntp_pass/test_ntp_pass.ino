...
static char ssid[] = "Extender_21086E";  //  your network SSID (name)
static char pass[] = "catalog999";       // your network password

static unsigned int localPort = 123;
static IPAddress timeServerIP;
static const char* ntpServerName = "ntp0.ntp-servers.net";
